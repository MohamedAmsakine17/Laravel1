...
<main class="main-container">
    <div class="container">
        ...
        <h2 class="category-name">Tout les articles</h2>
        <hr class="mt-5">
        <div class="d-flex justify-content-between">
            ...
            <div class="filters-container">
                <div class="dropdown d-lg-block d-none">
                    <div>
                        ...
                        <div class="dropdown-menu filter-dropdown-menu dropdown-menu-right">
                          <a class="dropdown-item filter-dropdown-item" href="{{route('articles',['php',$filter,$n])}}"> PHP Scripts </a>
                          <a class="dropdown-item filter-dropdown-item" href="{{route('articles',['plugins',$filter,$n])}}"> Plugins </a>
                          <a class="dropdown-item filter-dropdown-item" href="{{route('articles',['ui',$filter,$n])}}"> Modèles </a>
                          <a class="dropdown-item filter-dropdown-item" href="{{route('articles',['app',$filter,$n])}}"> APPs </a>
                          <a class="dropdown-item filter-dropdown-item" href="{{route('articles',['unity',$filter,$n])}}"> Unity </a>
                        </div>
                    </div>
                </div>
                <div class="dropdown show">
                    ...
                    <div class="dropdown-menu filter-dropdown-menu dropdown-menu-right">
                      <a class="dropdown-item filter-dropdown-item" href="{{route('allarticles',['popular',$n])}}"> Populaire </a>
                      <a class="dropdown-item filter-dropdown-item" href="{{route('allarticles',['new',$n])}}"> Nouveau </a>
                      <a class="dropdown-item filter-dropdown-item" href="{{route('allarticles',['paid',$n])}}"> Payé </a>
                      <a class="dropdown-item filter-dropdown-item" href="{{route('allarticles',['prixH',$n])}}"> Prix (élevé à bas) </a>
                      <a class="dropdown-item filter-dropdown-item" href="{{route('allarticles',['prixL',$n])}}"> Prix ​​(bas a élevé) </a>
                      <a class="dropdown-item filter-dropdown-item" href="{{route('allarticles',['free',$n])}}"> Gratuit </a>
                    </div>
                  </div>
                <div class="dropdown">
                    <div>
                        ...
                        <div class="dropdown-menu filter-dropdown-menu dropdown-menu-right">
                          <a class="dropdown-item filter-dropdown-item" href="{{route('allarticles',[$filter,4])}}"> 4 </a>
                          <a class="dropdown-item filter-dropdown-item" href="{{route('allarticles',[$filter,8])}}"> 8 </a>
                          <a class="dropdown-item filter-dropdown-item" href="{{route('allarticles',[$filter,16])}}"> 16 </a>
                          <a class="dropdown-item filter-dropdown-item" href="{{route('allarticles',[$filter,32])}}"> 32 </a>
                        </div>
                    </div>
                </div>
            </div>
