            ...
            @foreach($users as $user)
                <tr scope="row">
                    ...
                    <td class="table-data-mobile">
                        <div class="users-user-img-container">
                            <div class="picture" style= "background-image: url({{$user->getFirstMediaUrl('userImage', 'thumb')}}); background-repeat: no-repeat; background-size: cover; background-position: center;"></div>
                        </div>
                    </td>
                    <td class="table-data-mobile">
                        {{$user->role->name}}
